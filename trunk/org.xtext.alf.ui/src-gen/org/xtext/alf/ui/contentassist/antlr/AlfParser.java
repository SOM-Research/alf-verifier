...
* generated by Xtext
*/
package org.xtext.alf.ui.contentassist.antlr;
...
public class AlfParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.alf.ui.contentassist.antlr.internal.InternalAlfParser createParser() {
		org.xtext.alf.ui.contentassist.antlr.internal.InternalAlfParser result = new org.xtext.alf.ui.contentassist.antlr.internal.InternalAlfParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLinkOperationTupleAccess().getGroup_1(), "rule__LinkOperationTuple__Group_1__0");
					put(grammarAccess.getLinkOperationTupleAccess().getGroup_1_1(), "rule__LinkOperationTuple__Group_1_1__0");
					...
					put(grammarAccess.getLoopVariableDefinitionAccess().getGroup(), "rule__LoopVariableDefinition__Group__0");
					...
					put(grammarAccess.getOperationsAccess().getImportsAssignment_0_0(), "rule__Operations__ImportsAssignment_0_0");
					put(grammarAccess.getOperationsAccess().getOperationsAssignment_1(), "rule__Operations__OperationsAssignment_1");
					...
					put(grammarAccess.getOperationDeclarationAccess().getReturnTypeAssignment_3_1(), "rule__OperationDeclaration__ReturnTypeAssignment_3_1");
					put(grammarAccess.getOperationDeclarationAccess().getRedefinitionAssignment_4(), "rule__OperationDeclaration__RedefinitionAssignment_4");
					...
					put(grammarAccess.getLinkOperationTupleAccess().getLinkOperationTupleElementAssignment_1_0(), "rule__LinkOperationTuple__LinkOperationTupleElementAssignment_1_0");
					put(grammarAccess.getLinkOperationTupleAccess().getLinkOperationTupleElementAssignment_1_1_1(), "rule__LinkOperationTuple__LinkOperationTupleElementAssignment_1_1_1");
					...
					put(grammarAccess.getLinkOperationTupleElementAccess().getObjectValueSpecAssignment_1_2(), "rule__LinkOperationTupleElement__ObjectValueSpecAssignment_1_2");
					...
					put(grammarAccess.getSelectOrRejectOperationAccess().getExpr1Assignment_3(), "rule__SelectOrRejectOperation__Expr1Assignment_3");
					put(grammarAccess.getSelectOrRejectOperationAccess().getExpr2Assignment_5(), "rule__SelectOrRejectOperation__Expr2Assignment_5");
					put(grammarAccess.getSelectOrRejectOperationAccess().getExpr3Assignment_7(), "rule__SelectOrRejectOperation__Expr3Assignment_7");
					put(grammarAccess.getSelectOrRejectOperationAccess().getExpr4Assignment_9(), "rule__SelectOrRejectOperation__Expr4Assignment_9");
					put(grammarAccess.getSelectOrRejectOperationAccess().getSuffixAssignment_11(), "rule__SelectOrRejectOperation__SuffixAssignment_11");
					put(grammarAccess.getCollectOrIterateOperationAccess().getOpAssignment_1(), "rule__CollectOrIterateOperation__OpAssignment_1");
					put(grammarAccess.getCollectOrIterateOperationAccess().getExpr1Assignment_3(), "rule__CollectOrIterateOperation__Expr1Assignment_3");
					put(grammarAccess.getCollectOrIterateOperationAccess().getExpr2Assignment_5(), "rule__CollectOrIterateOperation__Expr2Assignment_5");
					put(grammarAccess.getCollectOrIterateOperationAccess().getExpr3Assignment_7(), "rule__CollectOrIterateOperation__Expr3Assignment_7");
					put(grammarAccess.getCollectOrIterateOperationAccess().getExpr4Assignment_9(), "rule__CollectOrIterateOperation__Expr4Assignment_9");
					put(grammarAccess.getCollectOrIterateOperationAccess().getSuffixAssignment_11(), "rule__CollectOrIterateOperation__SuffixAssignment_11");
					...
					put(grammarAccess.getForAllOrExistsOrOneOperationAccess().getExpr1Assignment_3(), "rule__ForAllOrExistsOrOneOperation__Expr1Assignment_3");
					put(grammarAccess.getForAllOrExistsOrOneOperationAccess().getExpr2Assignment_5(), "rule__ForAllOrExistsOrOneOperation__Expr2Assignment_5");
					put(grammarAccess.getForAllOrExistsOrOneOperationAccess().getExpr3Assignment_7(), "rule__ForAllOrExistsOrOneOperation__Expr3Assignment_7");
					put(grammarAccess.getForAllOrExistsOrOneOperationAccess().getExpr4Assignment_9(), "rule__ForAllOrExistsOrOneOperation__Expr4Assignment_9");
					put(grammarAccess.getForAllOrExistsOrOneOperationAccess().getSuffixAssignment_11(), "rule__ForAllOrExistsOrOneOperation__SuffixAssignment_11");
					...
					put(grammarAccess.getForControlAccess().getLoopVariableDefinitionAssignment(), "rule__ForControl__LoopVariableDefinitionAssignment");
					put(grammarAccess.getLoopVariableDefinitionAccess().getNameAssignment_0(), "rule__LoopVariableDefinition__NameAssignment_0");
					put(grammarAccess.getLoopVariableDefinitionAccess().getExpression1Assignment_2(), "rule__LoopVariableDefinition__Expression1Assignment_2");
					put(grammarAccess.getLoopVariableDefinitionAccess().getExpression2Assignment_4(), "rule__LoopVariableDefinition__Expression2Assignment_4");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.alf.ui.contentassist.antlr.internal.InternalAlfParser typedParser = (org.xtext.alf.ui.contentassist.antlr.internal.InternalAlfParser) parser;
			typedParser.entryRuleOperations();
