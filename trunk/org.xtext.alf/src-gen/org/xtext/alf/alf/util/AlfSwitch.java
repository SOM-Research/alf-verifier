...
public class AlfSwitch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case AlfPackage.NUMBER_LITERAL_WITHOUT_SUFFIX:
      {
      ...
      case AlfPackage.INTEGER_LITERAL_WITHOUT_SUFFIX:
      {
      ...
      case AlfPackage.UNLIMITED_LITERAL_WITHOUT_SUFFIX:
      {
      ...
      case AlfPackage.OPERATION_CALL_EXPRESSION_WITHOUT_DOT:
      {
        ...
        T result = caseOperationCallExpressionWithoutDot(operationCallExpressionWithoutDot);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   * @generated
   */
  public T caseOperationCallExpressionWithoutDot(OperationCallExpressionWithoutDot object)
  {
    return null;
  }
