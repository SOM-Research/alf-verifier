 ...
 * <ul>
 *   <li>{@link org.xtext.alf.alf.ClassificationToClause#getQualifiedNameList <em>Qualified Name List</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.alf.alf.AlfPackage#getClassificationToClause()
 * @model
 * @generated
 */
public interface ClassificationToClause extends EObject
{
   ...
   * @see org.xtext.alf.alf.AlfPackage#getClassificationToClause_QualifiedNameList()
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.ClassificationToClause#getQualifiedNameList <em>Qualified Name List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
