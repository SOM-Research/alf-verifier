 ...
 * <!-- end-user-doc -->
 * @see org.xtext.alf.alf.AlfPackage#getLinkOperationKind()
 * @model
 * @generated
 */
public enum LinkOperationKind implements Enumerator
{
  ...
  /**
   * The '<em><b>DESTROY OBJECT</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #DESTROY_OBJECT_VALUE
   * @generated
   * @ordered
   */
  DESTROY_OBJECT(3, "DESTROY_OBJECT", "destroy");
  ...
  /**
   * The '<em><b>DESTROY OBJECT</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>DESTROY OBJECT</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #DESTROY_OBJECT
   ...
   * @ordered
   */
  public static final int DESTROY_OBJECT_VALUE = 3;
  ...
  public static LinkOperationKind get(int value)
  {
    switch (value)
    {
      ...
      case DESTROY_OBJECT_VALUE: return DESTROY_OBJECT;
    }
    return null;
  }
