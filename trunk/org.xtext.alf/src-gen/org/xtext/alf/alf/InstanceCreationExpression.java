 ...
 * <ul>
 *   <li>{@link org.xtext.alf.alf.InstanceCreationExpression#getConstructor <em>Constructor</em>}</li>
 *   <li>{@link org.xtext.alf.alf.InstanceCreationExpression#getTuple <em>Tuple</em>}</li>
 *   <li>{@link org.xtext.alf.alf.InstanceCreationExpression#getSequenceConstuctionCompletion <em>Sequence Constuction Completion</em>}</li>
 *   <li>{@link org.xtext.alf.alf.InstanceCreationExpression#getSuffix <em>Suffix</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.alf.alf.AlfPackage#getInstanceCreationExpression()
 * @model
 * @generated
 */
public interface InstanceCreationExpression extends ValueSpecification, NonLiteralValueSpecification
{
   ...
   * @see org.xtext.alf.alf.AlfPackage#getInstanceCreationExpression_Constructor()
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.InstanceCreationExpression#getConstructor <em>Constructor</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setTuple(Tuple)
   * @see org.xtext.alf.alf.AlfPackage#getInstanceCreationExpression_Tuple()
   * @model containment="true"
   * @generated
   */
  Tuple getTuple();
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.InstanceCreationExpression#getTuple <em>Tuple</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getInstanceCreationExpression_SequenceConstuctionCompletion()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.InstanceCreationExpression#getSequenceConstuctionCompletion <em>Sequence Constuction Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getInstanceCreationExpression_Suffix()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.InstanceCreationExpression#getSuffix <em>Suffix</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
