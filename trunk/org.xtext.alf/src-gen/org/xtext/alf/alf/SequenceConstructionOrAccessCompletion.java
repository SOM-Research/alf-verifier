 ...
 * <ul>
 *   <li>{@link org.xtext.alf.alf.SequenceConstructionOrAccessCompletion#isMultiplicityIndicator <em>Multiplicity Indicator</em>}</li>
 *   <li>{@link org.xtext.alf.alf.SequenceConstructionOrAccessCompletion#getAccessCompletion <em>Access Completion</em>}</li>
 *   <li>{@link org.xtext.alf.alf.SequenceConstructionOrAccessCompletion#getSequenceCompletion <em>Sequence Completion</em>}</li>
 *   <li>{@link org.xtext.alf.alf.SequenceConstructionOrAccessCompletion#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.alf.alf.AlfPackage#getSequenceConstructionOrAccessCompletion()
 * @model
 * @generated
 */
public interface SequenceConstructionOrAccessCompletion extends EObject
{
   ...
   * @see org.xtext.alf.alf.AlfPackage#getSequenceConstructionOrAccessCompletion_MultiplicityIndicator()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.SequenceConstructionOrAccessCompletion#isMultiplicityIndicator <em>Multiplicity Indicator</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getSequenceConstructionOrAccessCompletion_AccessCompletion()
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.SequenceConstructionOrAccessCompletion#getAccessCompletion <em>Access Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getSequenceConstructionOrAccessCompletion_SequenceCompletion()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.SequenceConstructionOrAccessCompletion#getSequenceCompletion <em>Sequence Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getSequenceConstructionOrAccessCompletion_Expression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.SequenceConstructionOrAccessCompletion#getExpression <em>Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
