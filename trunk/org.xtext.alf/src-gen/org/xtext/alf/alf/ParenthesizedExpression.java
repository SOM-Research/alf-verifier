 ...
 * <ul>
 *   <li>{@link org.xtext.alf.alf.ParenthesizedExpression#getExpOrTypeCast <em>Exp Or Type Cast</em>}</li>
 *   <li>{@link org.xtext.alf.alf.ParenthesizedExpression#getCasted <em>Casted</em>}</li>
 *   <li>{@link org.xtext.alf.alf.ParenthesizedExpression#getSuffix <em>Suffix</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.alf.alf.AlfPackage#getParenthesizedExpression()
 * @model
 * @generated
 */
public interface ParenthesizedExpression extends ValueSpecification, NonLiteralValueSpecification
{
   ...
   * @see org.xtext.alf.alf.AlfPackage#getParenthesizedExpression_ExpOrTypeCast()
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.ParenthesizedExpression#getExpOrTypeCast <em>Exp Or Type Cast</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getParenthesizedExpression_Casted()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.ParenthesizedExpression#getCasted <em>Casted</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getParenthesizedExpression_Suffix()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.ParenthesizedExpression#getSuffix <em>Suffix</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
