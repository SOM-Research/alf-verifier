 ...
 * <ul>
 *   <li>{@link org.xtext.alf.alf.ThisExpression#getSuffix <em>Suffix</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.alf.alf.AlfPackage#getThisExpression()
 * @model
 * @generated
 */
public interface ThisExpression extends ValueSpecification, NonLiteralValueSpecification
{
   ...
   * @see org.xtext.alf.alf.AlfPackage#getThisExpression_Suffix()
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.ThisExpression#getSuffix <em>Suffix</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
