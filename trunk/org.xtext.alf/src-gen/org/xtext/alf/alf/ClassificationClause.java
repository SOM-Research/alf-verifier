 ...
 * <ul>
 *   <li>{@link org.xtext.alf.alf.ClassificationClause#getClassifyFromClause <em>Classify From Clause</em>}</li>
 *   <li>{@link org.xtext.alf.alf.ClassificationClause#getClassifyToClause <em>Classify To Clause</em>}</li>
 *   <li>{@link org.xtext.alf.alf.ClassificationClause#getReclassyAllClause <em>Reclassy All Clause</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.alf.alf.AlfPackage#getClassificationClause()
 * @model
 * @generated
 */
public interface ClassificationClause extends EObject
{
   ...
   * @see org.xtext.alf.alf.AlfPackage#getClassificationClause_ClassifyFromClause()
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.ClassificationClause#getClassifyFromClause <em>Classify From Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getClassificationClause_ClassifyToClause()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.ClassificationClause#getClassifyToClause <em>Classify To Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getClassificationClause_ReclassyAllClause()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.ClassificationClause#getReclassyAllClause <em>Reclassy All Clause</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
