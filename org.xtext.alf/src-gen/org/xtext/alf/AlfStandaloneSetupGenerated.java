...
public class AlfStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.xtext.alf.AlfRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.xtext.org/alf/Alf")) {
		EPackage.Registry.INSTANCE.put("http://www.xtext.org/alf/Alf", org.xtext.alf.alf.AlfPackage.eINSTANCE);
	}
