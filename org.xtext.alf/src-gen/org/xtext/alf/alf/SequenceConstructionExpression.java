 ...
 * <ul>
 *   <li>{@link org.xtext.alf.alf.SequenceConstructionExpression#getSequenceElement <em>Sequence Element</em>}</li>
 *   <li>{@link org.xtext.alf.alf.SequenceConstructionExpression#getRangeUpper <em>Range Upper</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.alf.alf.AlfPackage#getSequenceConstructionExpression()
 * @model
 * @generated
 */
public interface SequenceConstructionExpression extends SequenceElement
{
   ...
   * The list contents are of type {@link org.xtext.alf.alf.SequenceElement}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.xtext.alf.alf.AlfPackage#getSequenceConstructionExpression_SequenceElement()
   ...
   * @see org.xtext.alf.alf.AlfPackage#getSequenceConstructionExpression_RangeUpper()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.SequenceConstructionExpression#getRangeUpper <em>Range Upper</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
