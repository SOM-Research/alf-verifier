 ...
 * <ul>
 *   <li>{@link org.xtext.alf.alf.SuperInvocationExpression#getClassName <em>Class Name</em>}</li>
 *   <li>{@link org.xtext.alf.alf.SuperInvocationExpression#getOperationCallWithoutDot <em>Operation Call Without Dot</em>}</li>
 *   <li>{@link org.xtext.alf.alf.SuperInvocationExpression#getOperationCall <em>Operation Call</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.alf.alf.AlfPackage#getSuperInvocationExpression()
 * @model
 * @generated
 */
public interface SuperInvocationExpression extends ValueSpecification, NonLiteralValueSpecification
{
   ...
   * @see org.xtext.alf.alf.AlfPackage#getSuperInvocationExpression_ClassName()
   * @model
   * @generated
   */
  String getClassName();
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.SuperInvocationExpression#getClassName <em>Class Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getSuperInvocationExpression_OperationCallWithoutDot()
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.SuperInvocationExpression#getOperationCallWithoutDot <em>Operation Call Without Dot</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getSuperInvocationExpression_OperationCall()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.SuperInvocationExpression#getOperationCall <em>Operation Call</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
