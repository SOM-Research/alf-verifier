 ...
 * <ul>
 *   <li>{@link org.xtext.alf.alf.SwitchClause#getSwitchCase <em>Switch Case</em>}</li>
 *   <li>{@link org.xtext.alf.alf.SwitchClause#getStatementSequence <em>Statement Sequence</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.alf.alf.AlfPackage#getSwitchClause()
 * @model
 * @generated
 */
public interface SwitchClause extends EObject
{
   ...
   * The list contents are of type {@link org.xtext.alf.alf.SwitchCase}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.xtext.alf.alf.AlfPackage#getSwitchClause_SwitchCase()
   ...
   * @see org.xtext.alf.alf.AlfPackage#getSwitchClause_StatementSequence()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.SwitchClause#getStatementSequence <em>Statement Sequence</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
