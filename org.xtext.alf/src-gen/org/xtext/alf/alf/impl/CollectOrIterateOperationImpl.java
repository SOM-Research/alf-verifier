 ...
 * <ul>
 *   <li>{@link org.xtext.alf.alf.impl.CollectOrIterateOperationImpl#getOp <em>Op</em>}</li>
 *   <li>{@link org.xtext.alf.alf.impl.CollectOrIterateOperationImpl#getExpr1 <em>Expr1</em>}</li>
 *   <li>{@link org.xtext.alf.alf.impl.CollectOrIterateOperationImpl#getExpr2 <em>Expr2</em>}</li>
 *   <li>{@link org.xtext.alf.alf.impl.CollectOrIterateOperationImpl#getExpr3 <em>Expr3</em>}</li>
 *   <li>{@link org.xtext.alf.alf.impl.CollectOrIterateOperationImpl#getExpr4 <em>Expr4</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollectOrIterateOperationImpl extends SequenceExpansionExpressionImpl implements CollectOrIterateOperation
{
  ...
  public void setExpr1(String newExpr1)
  {
    ...
    expr1 = newExpr1;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlfPackage.COLLECT_OR_ITERATE_OPERATION__EXPR1, oldExpr1, expr1));
  }
  ...
  public void setExpr2(String newExpr2)
  {
    ...
    expr2 = newExpr2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlfPackage.COLLECT_OR_ITERATE_OPERATION__EXPR2, oldExpr2, expr2));
  }
  ...
  public void setExpr3(String newExpr3)
  {
    ...
    expr3 = newExpr3;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlfPackage.COLLECT_OR_ITERATE_OPERATION__EXPR3, oldExpr3, expr3));
  }
  ...
  public void setExpr4(String newExpr4)
  {
    ...
    expr4 = newExpr4;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlfPackage.COLLECT_OR_ITERATE_OPERATION__EXPR4, oldExpr4, expr4));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AlfPackage.COLLECT_OR_ITERATE_OPERATION__OP:
        return getOp();
      case AlfPackage.COLLECT_OR_ITERATE_OPERATION__EXPR1:
        return getExpr1();
      case AlfPackage.COLLECT_OR_ITERATE_OPERATION__EXPR2:
        return getExpr2();
      case AlfPackage.COLLECT_OR_ITERATE_OPERATION__EXPR3:
        return getExpr3();
      case AlfPackage.COLLECT_OR_ITERATE_OPERATION__EXPR4:
        return getExpr4();
    }
