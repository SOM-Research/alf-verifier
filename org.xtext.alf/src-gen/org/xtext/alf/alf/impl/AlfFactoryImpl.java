...
public class AlfFactoryImpl extends EFactoryImpl implements AlfFactory
{
  ...
  public static AlfFactory init()
  {
    try
    {
      AlfFactory theAlfFactory = (AlfFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.xtext.org/alf/Alf"); 
  ...
  public EObject create(EClass eClass)
  {
    ...
    {
      case AlfPackage.OPERATIONS: return createOperations();
      ...
      case AlfPackage.NUMBER_LITERAL_WITHOUT_SUFFIX: return createNUMBER_LITERAL_WITHOUT_SUFFIX();
      case AlfPackage.INTEGER_LITERAL_WITHOUT_SUFFIX: return createINTEGER_LITERAL_WITHOUT_SUFFIX();
      case AlfPackage.UNLIMITED_LITERAL_WITHOUT_SUFFIX: return createUNLIMITED_LITERAL_WITHOUT_SUFFIX();
      ...
      case AlfPackage.OPERATION_CALL_EXPRESSION_WITHOUT_DOT: return createOperationCallExpressionWithoutDot();
  ...
  {
    OperationCallExpressionWithoutDotImpl operationCallExpressionWithoutDot = new OperationCallExpressionWithoutDotImpl();
    return operationCallExpressionWithoutDot;
  }
