 ...
 * <ul>
 *   <li>{@link org.xtext.alf.alf.PrimaryExpression#getPrefix <em>Prefix</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.alf.alf.AlfPackage#getPrimaryExpression()
 * @model
 * @generated
 */
public interface PrimaryExpression extends EObject
{
   ...
   * @see org.xtext.alf.alf.AlfPackage#getPrimaryExpression_Prefix()
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.PrimaryExpression#getPrefix <em>Prefix</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
