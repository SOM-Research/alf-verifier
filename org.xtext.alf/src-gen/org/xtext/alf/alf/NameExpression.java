 ...
 * <ul>
 *   <li>{@link org.xtext.alf.alf.NameExpression#getPrefixOp <em>Prefix Op</em>}</li>
 *   <li>{@link org.xtext.alf.alf.NameExpression#getPath <em>Path</em>}</li>
 *   <li>{@link org.xtext.alf.alf.NameExpression#getId <em>Id</em>}</li>
 *   <li>{@link org.xtext.alf.alf.NameExpression#getInvocationCompletion <em>Invocation Completion</em>}</li>
 *   <li>{@link org.xtext.alf.alf.NameExpression#getSequenceConstructionCompletion <em>Sequence Construction Completion</em>}</li>
 *   <li>{@link org.xtext.alf.alf.NameExpression#getPostfixOp <em>Postfix Op</em>}</li>
 *   <li>{@link org.xtext.alf.alf.NameExpression#getSuffix <em>Suffix</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.alf.alf.AlfPackage#getNameExpression()
 * @model
 * @generated
 */
public interface NameExpression extends ValueSpecification, NonLiteralValueSpecification
{
   ...
   * @see org.xtext.alf.alf.AlfPackage#getNameExpression_PrefixOp()
   * @model
   * @generated
   */
  String getPrefixOp();
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.NameExpression#getPrefixOp <em>Prefix Op</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getNameExpression_Path()
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.NameExpression#getPath <em>Path</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setId(String)
   * @see org.xtext.alf.alf.AlfPackage#getNameExpression_Id()
   * @model
   * @generated
   */
  String getId();
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.NameExpression#getId <em>Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getNameExpression_InvocationCompletion()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.NameExpression#getInvocationCompletion <em>Invocation Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getNameExpression_SequenceConstructionCompletion()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.NameExpression#getSequenceConstructionCompletion <em>Sequence Construction Completion</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getNameExpression_PostfixOp()
   * @model
   * @generated
   */
  String getPostfixOp();
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.NameExpression#getPostfixOp <em>Postfix Op</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.alf.alf.AlfPackage#getNameExpression_Suffix()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.alf.alf.NameExpression#getSuffix <em>Suffix</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
